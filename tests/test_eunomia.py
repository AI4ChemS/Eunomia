...
class TestGeneral(unittest.TestCase):
    ...
    def test_match_MOF_names(self):
        ...
        combined_dict, matched_pairs = eunomia.match_MOF_names(prediction_dict, ground_truth_dict, threshold=70)
        ...
        self.assertDictEqual(combined_dict['MOF-74'], {
            'Predicted Stability': 'Stable',
            'Paper id': '2',
            'Ground-truth Stability': 'Unstable'
        })
        self.assertDictEqual(combined_dict['MOF-508b'], {
            'Predicted Stability': 'Stable',
            'Paper id': '2',
            'Ground-truth Stability': 'Unstable'
        })
        self.assertDictEqual(combined_dict['HKUST-1'], {
            'Predicted Stability': 'Stable',
            'Paper id': '2',
            'Ground-truth Stability': 'Unstable'
        })
